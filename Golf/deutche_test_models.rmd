---
title: "Deutche Championship Test Models"
author: "Tate Campbell"
date: "September 1, 2015"
output: pdf_document
---

Three test models for projecting fantasy points for the upcoming Deutche Championship. 

#Weights of Golf Stats


**MODEL | points | fedex | drive_dist | drive_acc | scramble | GIR**\newline
<br>T1 | 40 | 10 | 10 | 10 | 10 | 20\newline
Ty1| 10 | 7.5| 30 | 15 | 7.5| 30\newline 
Nas| 30 | 10 | 5  | 15 | 15 | 25\newline

#Rankings
```{r ,set-options, echo=FALSE, comment=NA}
options(width = 120)
setwd("~/Documents/golf_projects")
...
names(test_models) <- c("Original", "T1", "Ty1", "Nas")
test_models
```
